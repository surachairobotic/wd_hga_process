...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_width',                  'default': WIDTH, 'description': 'depth image width'},
                           {'name': 'depth_height',                 'default': HEIGHT, 'description': 'depth image height'},
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'color_width',                  'default': WIDTH, 'description': 'color image width'},
                           {'name': 'color_height',                 'default': HEIGHT, 'description': 'color image height'},
                           {'name': 'enable_color',                 'default': 'true', 'description': 'enable color stream'},
                           {'name': 'infra_width',                  'default': WIDTH, 'description': 'infra width'},
                           ...
                           {'name': 'confidence_width',             'default': WIDTH, 'description': 'depth image width'},
                           {'name': 'confidence_height',            'default': HEIGHT, 'description': 'depth image height'},
                           {'name': 'enable_confidence',            'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'fisheye_fps',                  'default': FPS, 'description': ''},
                           {'name': 'depth_fps',                    'default': FPS, 'description': ''},
                           {'name': 'confidence_fps',               'default': FPS, 'description': ''},
                           {'name': 'infra_fps',                    'default': FPS, 'description': ''},
                           {'name': 'color_fps',                    'default': FPS, 'description': ''},
                           {'name': 'gyro_fps',                     'default': IMU_FPS, 'description': ''},
                           {'name': 'accel_fps',                    'default': IMU_FPS, 'description': ''},
